			...
			<div class="col-md-12">				
				<div class="panel panel-primary" data-collapsed="0">				
					...
					<div class="panel-body">
                         {!! Form::model($campaign, array('action' => array('CampaignsController@update', $campaign->id),  'class'=>'form-horizontal','role'=>'form' ,'method' => 'PUT')) 
                    !!}
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<div class="input-group">
										{{ Form::text('start_date', null,['placeholder'=>'','class'=>'form-control datepicker','data-format'=>'yyyy-mm-dd 00:00:00']) }}
										<!--D, dd MM yyyy-->
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<div class="input-group">
										{{ Form::text('end_date', null,['placeholder'=>'','class'=>'form-control datepicker','data-format'=>'yyyy-mm-dd 00:00:00']) }}
